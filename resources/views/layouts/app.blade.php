...
<head>
    ...
    <title>{{ config('app.name', 'Match Ticket System') }}</title>
    <!-- Styles -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">Match Tickets</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.matches.create') }}">Create Matches</a>
                    </li>
                    <li class="nav-item">
    ...
    <footer class="py-4 bg-light mt-5">
        <div class="container text-center">
            <p>&copy; {{ date('Y') }} Match Ticket System</p>
        </div>
    </footer>
